...
class PageIndexController extends GetxController {
  ...
  CancelToken doAbsenCancel = CancelToken();
  Dio dio = Dio();
        ...
        if (dataResponse['error'] == true) {
          ...
          Get.dialog(
            AlertDialog(
              ...
              content: const Text("Apakah anda ingin melakukan absen?"),
              actions: [
                TextButton(
                  onPressed: () {
                    Get.back();
  ...
  Future<Map<String, dynamic>> presence2(Position position) async {
    try {
      String endpoint = "$baseUrlAPI/v1/doabsen";

      dio2.FormData formData = dio2.FormData.fromMap({
        "user_id": homeC.mapUser['data']['id'].toString(),
      ...
      if (e.response!.statusCode == 404) {
        ...
        debugPrint("Terlalu Banyak Request ke Server");
      }
